...
class Demo_PM_QP : public QObject, public DemoduletionFactroy
{
	Q_OBJECT
...
public:
	...
	Demo_PM_QP(int index);

	~Demo_PM_QP();

	void Demodulation(Complex* data_input_slice, long long llBaseTime, DemodulationResult* signal_PM_QP_Out);
	...
	double std(float* data, int start, int end);
public:
